...
namespace VSEngine2 {
    ...
    public:
        ...
        static unsigned int WaitAll(VSSynchronize * * pSynchronize,
            unsigned int uiNum, bool bWaitAll,DWORD dwMilliseconds = (DWORD)-1);
    };
    class VSSYSTEM_API VSCriticalSection {//临界区
#ifdef WINDOWS_PLATFORM
        /**
        * The windows specific critical section
        */
        CRITICAL_SECTION CriticalSection;//聚合临界区
#endif
    public:
        /**
...
*/
     ...
     */
        ...
        */
        ...
        class VSSYSTEM_API VSSemaphore : public VSSynchronize//信号量
        {
        public:
